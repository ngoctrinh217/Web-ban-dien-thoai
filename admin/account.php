...
<button class='blob-btn btn-add-account' data-bs-toggle='modal' data-bs-target='#exampleModalAdd'>
    Thêm tài khoản
...
<section class='intro account-admin'>
...
<nav class='pagination-account' aria-label='Page navigation example'>
